                    ...
                    >
                      ...
                      >
                        <Avatar
                          ...
                          src={
                            agentInfo?.Media?.[0]?.MediaURL || defaultProfile
                          }
        ...
        {!isFullscreen && (
          ...
          >
            <Typography variant="caption">
              Listing: {Math.round(listingSwitchMs / 1000)}s · Photos:{" "}
              {Math.round(photoRotateMs / 1000)}s · Uploads:{" "}
              {Math.round(uploadedRotateMs / 1000)}s
            </Typography>
          </Box>
        )}
        <IconButton
